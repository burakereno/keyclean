...
KeyClean release builds are Developer ID signed and notarized in GitHub Actions. Configure these repository secrets before pushing a release commit to `main`:
